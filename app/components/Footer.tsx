        ...
        <footer className="flex flex-col gap-6 px-5 py-10 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="#" className="hover:scale-110 transition-transform">
              <div className="transition-colors" style={{ color: 'var(--text-secondary)' }} onMouseEnter={(e) => e.currentTarget.style.color = 'var(--accent)'} onMouseLeave={(e) => e.currentTarget.style.color = 'var(--text-secondary)'}>
          ...
          <p className="text-sm md:text-base font-normal leading-normal" style={{ color: 'var(--text-secondary)' }}>@2024 Leziz. Tüm hakları saklıdır.</p>
        </footer>
      </div>
    </footer>
  );
