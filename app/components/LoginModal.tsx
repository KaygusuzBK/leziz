      ...
      <div className="relative p-4 rounded-xl ">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
          ...
          <div className="text-right">
            <button
              type="button"
              className="text-sm transition-colors text-accent hover:opacity-80"
            >
              Şifremi Unuttum
            </button>
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3 px-4 rounded-xl font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed bg-accent text-white hover-accent"
          >
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border transition-colors disabled:opacity-50 disabled:cursor-not-allowed bg-card text-primary border-card hover-card"
            >
