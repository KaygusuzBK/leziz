...
export default function HakkimizdaPage() {
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-orange-500 to-orange-600 dark:from-orange-600 dark:to-orange-700 py-20">
        ...
        <div className="absolute bottom-10 right-10 w-32 h-32 bg-orange-300 rounded-full opacity-30 animate-pulse delay-1000"></div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-orange-700 dark:text-orange-300 font-medium">Tarif</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-orange-600 dark:text-orange-400 mb-2">50K+</div>
              <div className="text-orange-700 dark:text-orange-300 font-medium">Kullanıcı</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-orange-600 dark:text-orange-400 mb-2">100+</div>
              <div className="text-orange-700 dark:text-orange-300 font-medium">Kategori</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-orange-600 dark:text-orange-400 mb-2">5M+</div>
              <div className="text-orange-700 dark:text-orange-300 font-medium">Görüntülenme</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-6">Misyonumuz</h2>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-gray-900 dark:text-white font-medium">Kaliteli ve Güvenilir Tarifler</span>
              </div>
            </div>
      ...
      <section className="py-20 bg-orange-50 dark:bg-orange-900/20">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white text-center mb-12">Değerlerimiz</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center p-8 hover:shadow-lg transition-shadow bg-white dark:bg-gray-900">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Kalite</h3>
            ...
            <Card className="text-center p-8 hover:shadow-lg transition-shadow bg-white dark:bg-gray-900">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Tutku</h3>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <Card className="text-center p-8 hover:shadow-lg transition-shadow bg-white dark:bg-gray-900">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Topluluk</h3>
              <p className="text-gray-700 dark:text-gray-300">
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white text-center mb-12">Ekibimiz</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center p-6 bg-white dark:bg-gray-900">
            ...
            <Card className="text-center p-6 bg-white dark:bg-gray-900">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Mutfak Uzmanı</h3>
              <p className="text-orange-600 dark:text-orange-400 mb-4">Şef & İçerik Editörü</p>
              <p className="text-gray-700 dark:text-gray-300 text-sm">
            ...
            <Card className="text-center p-6 bg-white dark:bg-gray-900">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Teknoloji Uzmanı</h3>
              <p className="text-orange-600 dark:text-orange-400 mb-4">CTO & Geliştirici</p>
              <p className="text-gray-700 dark:text-gray-300 text-sm">
      ...
      <section className="py-20 bg-orange-50 dark:bg-orange-900/20">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white text-center mb-12">Bizi Ziyaret Edin</h2>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">İstanbul Merkez Ofisimiz</h3>
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300">Kadıköy, İstanbul, Türkiye</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-gray-900 dark:text-white font-medium">E-posta</p>
                    <p className="text-gray-700 dark:text-gray-300">info@leziz.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-gray-900 dark:text-white font-medium">Telefon</p>
                    <p className="text-gray-700 dark:text-gray-300">+90 (212) 555 0123</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gray-200 dark:bg-gray-800 rounded-2xl h-80 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400">Harita burada görünecek</p>
                <p className="text-gray-400 dark:text-gray-500 text-sm">Google Maps entegrasyonu</p>
              </div>
            </div>
          </div>
        </div>
